...
const Index = () => {
  const installationSteps = [
    ...
    },
    {
      stepNumber: 3,
      title: "Localizar APK",
      description: "Encuentra el archivo GolAgora.apk en tus descargas",
      details: [
    ...
    },
    {
      stepNumber: 4,
      title: "Instalar App",
      description: "Autoriza la instalación y disfruta de Gol Agora",
      details: [
        "Toca en 'Instalar'",
  ...
  function handledButton(){
    registerDownload()
    window.location.href = 'https://golagora.site/golagora.apk'
  }
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Siga estes passos simples para instalar o Gol Agora no seu dispositivo Android.
            </p>
          </div>
          ...
          {/* Success Message */}
          <div className="text-center bg-[#131212] rounded-2xl p-8 border border-primary/20">
      ...
      <div className="fixed bottom-[30px] right-[30px] cursor-pointer" onClick={() => {
        window.location.href = 'https://api.whatsapp.com/send?phone=556796885211'
      }}>
        <img src={imgWhatsApp} width={70} height={70} alt="Atendimento Agora APK" />
      </div>
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="container mx-auto text-center">
          <p className="text-muted-foreground">
            © 2024 Gol Agora. Todos os direitos reservados.
          </p>
        </div>
      </footer>
    </div>
