        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 flex justify-center flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-2 text-xl md:text-2xl text-muted-foreground mb-6">
              <Smartphone className="w-8 h-8 text-[#4e699c] " />
          ...
          <div className="animate-bounce">
            ...
            <div className="w-6 h-10 border-2 border-[#4e699c] rounded-full mx-auto flex justify-center">
              <div className="w-1 h-3 bg-[#4e699c] rounded-full mt-2 animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
