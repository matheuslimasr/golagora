...
const VideoTutorial = () => {
  ...
  return (
    <section className="py-20 px-4 bg-[#0C1423]">
      <div className="container mx-auto max-w-6xl">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-hero bg-clip-text text-transparent">
            Por que escolher Gol Agora?
          </h2>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            <div className="mb-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                O Gol Agora oferece a experiência mais completa para você acompanhar seus times favoritos.
De placares ao vivo a estatísticas detalhadas.
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
            ...
            >
              <img src={Fed1} className="w-[100%]" alt="Feedback - Gol Agora" />
            </div>

            <div 
              className="text-center p-0 bg-gradient-card rounded-xl border border-primary/10 hover:border-primary/30 transition-all duration-300 hover:shadow-card"
            >
              <img src={Fed2} className="w-[100%]" alt="Feedback - Gol Agora" />
            </div>

            <div 
              className="text-center p-0 bg-gradient-card rounded-xl border border-primary/10 hover:border-primary/30 transition-all duration-300 hover:shadow-card"
            >
              <img src={Fed3} className="w-[100%]" alt="Feedback - Gol Agora" />
            </div>

            <div 
              className="text-center p-0 bg-gradient-card rounded-xl border border-primary/10 hover:border-primary/30 transition-all duration-300 hover:shadow-card"
            >
              <img src={Fed4} className="w-[100%]" alt="Feedback - Gol Agora" />
            </div>
